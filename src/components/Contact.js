...
export default function Contact() {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm("service_3il76oa", "contact_form", form.current, "A94RP-peekJbrVZig")
        .then((result) => {
  ...
  return (
    ...
    <div className="mb-4">
      ...
      <div className="w-[50%] float-right" >
        ...
        <a className="w-[50%] float-left" href="+91-7696590016">+91-7696590016</a>
        </div>
      ...
      <div className="w-[50%] float-right">
               ...
               <a className="w-[50%] float-left" href="mailto:shrutikaushal12121@gmail.com">shrutikaushal12121@gmail.com</a>
           </div>
      </div>
      <div class="mb-4">
